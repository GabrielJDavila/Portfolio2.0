export default [
    ...
    },
    {
        ...
        description: "This is a simple invoice creator made with React. This project was made with the intention of gaining more familiarity with the basics of React (state, useEffect, props, etc).",
