    ...
    return (
        <main id="about" className="about-section">
            ...
            <div className="about-descrip-container">
                ...
                My background is in fitness; I have been in the industry as a trainer for 7+ years, and am especially interested in the intersection of tech, health, and sustainability.</p>
            </div>
        </main>
    )
}
